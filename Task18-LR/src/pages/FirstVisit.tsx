            ...
            <div className="flex justify-center items-center bg-slate-100">
                <div className="w-auto text-3xl px-6 py-12">
                    <div className="flex justify-center  items-center mb-4 ">
                        <p>&emsp;Welcome to </p><p className='text-indigo-600'> &nbsp;Fakebook&ensp;</p>
                    </div>
                    ...
                    <div className=" sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                            <p className=" text-center text-sm text-gray-500 px-6 py-6">
                                Not a member yet?&nbsp;
                                <a href="#" className="font-semibold leading-6 text-xl text-indigo-600 hover:text-indigo-500">Sign Up </a>
                                Now!
                            </p>
                        </div>
