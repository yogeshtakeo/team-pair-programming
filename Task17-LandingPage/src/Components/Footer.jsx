...
function Footer() {
 ...
 <footer>
    ...
    <div className="px-4 py-6 bg-rose-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">CUNY</a>. All Rights Reserved.
        </span>
