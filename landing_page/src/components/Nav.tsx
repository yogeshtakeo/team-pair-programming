...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="https://flowbite.com/" className="flex items-center">
      <img src="https://cdn2.vectorstock.com/i/1000x1000/06/96/logo-school-vector-19170696.jpg" className="h-8 mr-3" alt="Flowbite Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Frontend School</span>
  </a>
