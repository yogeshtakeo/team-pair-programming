          ...
          <div className="grid grid-cols-3 gap-5">
            <div className=" h-auto w-80  border-2 border-orange-400 rounded-md p-4  bg-black text-white ">
              <div>
                ...
                <p className="mt-2 text-md">
                  Learn about ChatGPT, one of the most advanced AI systems
                  available today, and dive into the world of Generative AI
                </p>
            ...
            <div className="h-64 w-80 border-2 border-orange-400 rounded-md p-4 gap-2 bg-black text-white">
              <div>
                ...
                <p className=" mt-2 text-md">
                  Learn the basics of the world’s fastest growing and most
                  popular programming language used by software engineers,
                  analysts, and machine learning engineers alike.
                </p>
                <button className=" ml-auto mt-6 p-1 underline decoration-white hover:scale-110 text-lg">
                  Select
                </button>
