...
<button type="submit" className=' uppercase border-2  border-zinc-600 bg-stone-900 shadow-md shadow-stone-700 rounded-xl p-4 w-32 mt-12 hover:scale-110'>Sign Up</button>
</div>
        ):
        (<div></div>
