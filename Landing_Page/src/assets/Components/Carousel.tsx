  ...
  const slides = [
    {
      img: img1,
      texts: [
        "Launch Your Career with an MBA Degree",
        "Unlock New Opportunities with our MBA Programs",
      ],
    }, //index-0
    {
      img: img2,
      texts: [
        "Experience World-Class Faculty and Research",
    ...
    }, //index-1
    {
      img: img3,
      texts: [
        "Join a Diverse and Collaborative Business Community",
        "Network with Ambitious Peers from Around the World",
      ],
    }, //index-2
    {
      img: img4,
      texts: [
        "Receive Guidance for Internships and Job Placements",
        "Enhance Your Job Prospects with Career Workshops and Coaching",
      ],
    }, //index-3
  ];
  //prev function
        ...
        <div className="w-full h-auto mt-32 flex flex-col justify-center">
          ...
          <div className="flex flex-col justify-center items-center p-10 border-2 border-zinc-400 h-74 border-l-0 border-r-0 ">
            {slides[index].texts.map((items: string, index: number) => (
              <li
                className="list-none text-neutral-100 text-3xl mb-8 mt-8"
                key={index}
              >
                {items}
              </li>
